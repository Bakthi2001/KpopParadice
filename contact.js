...
class SubmitButton extends React.Component {
  constructor(props) {
    ...
    this.onToggle = (e) => {
      ...
      console.log(
        buildMarkup(Draft.convertToRaw(editorState.getCurrentContent()), markup)
      );
      var markuppedBlocks = buildMarkup(
      ...
      var commentContent = (blocks) => {
        ...
        blocks.forEach((block, index, arr) => {
          if (block.blockType == "unstyled")
            commentText += "<p>" + block.styledMarkup + "</p>";
          if (block.blockType == "blockquote")
            commentText +=
              "<blockquote>" + block.styledMarkup + "</blockquote>";
          if (block.blockType == "code-block")
            commentText +=
              "<div class='box'><pre style='white-space: pre-wrap;'><code>" +
              block.styledMarkup +
              "</code></pre></div>";
        });
        return commentText;
